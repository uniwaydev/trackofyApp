...
class IdleSummary extends StatefulWidget {
  const IdleSummary({Key? key}) : super(key: key);

  @override
  State<IdleSummary> createState() => _IdleSummaryState();
}

class _IdleSummaryState extends State<IdleSummary> {
  ...
  void fetchData() async {
    ...
    SmartDialog.showLoading(msg: "Loading...");
    data = await ApiService.idleSummaryReport(
            ...
            child: !isApply
                ? Column(
                    ...
                    children: [
                      ...
                      Text(
                        "Please apply to see Idle Summary",
                        style: TextStyle(
                            color: Color(
                              0xff757575,
                            ),
