          ...
          child: Column(
            children: [
              Padding(
                ...
                child:
                    textField1(context, "Enter Driver Name*", driverNameCtrl),
              ),
              Padding(
                padding: EdgeInsets.only(top: 10),
                child: textField1(context, "Enter Mobile No*", mobileCtrl),
              ),
              Padding(
                padding: EdgeInsets.only(top: 10),
                child: textField1(context, "Enter Email*", emailCtrl),
              ),
              Padding(
                padding: EdgeInsets.only(top: 16),
                child: textField1(
                    context, "Enter Emergency Contact No*", contactCtrl),
              ),
              Padding(
                padding: EdgeInsets.only(top: 16),
